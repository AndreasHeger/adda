...
class AddaSummary( AddaModuleBlock ):
    ...
    def __init__(self, *args, **kwargs ):
        ...
        self.mFilenameTransfers = self.mConfig.get( "output", "fit_transfer", "adda.fit.transfer" )
        self.mFilenameDomains = self.mConfig.get( "output", "domains", "adda.domains" )
        self.mFilenameSummary = self.mConfig.get( "output", "summary", "adda.summary" )
        self.mFilenameDomainGraph = self.mConfig.get( "output", "domain_graph", "adda.domaingraph.gz" )
        self.mFilenameMst = self.mConfig.get( "output", "mst", "adda.mst" )
        self.mFilenameResult = self.mConfig.get( "output", "result", "adda.result" )
        self.mFilenameAlignments = self.mConfig.get("output","align", "adda.align" )
